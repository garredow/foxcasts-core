import { ApiService, DatabaseService } from '.';
...
export class PodcastService {
    ...
    public async getById(podcastId: number, includeEpisodes: boolean = false): Promise<Podcast> {
        return await this.databaseService.getPodcastById(podcastId, includeEpisodes);
    }
